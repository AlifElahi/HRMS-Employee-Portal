...
const Branch = () => {
    ...
    const [data, setData] = useState([
        { id: 1, branch_name: "Head Office", address: "41, kemeal ataturk avenue, banani dhaka", manager: 'mr.x' },
        { id: 2, branch_name: "Shantinagar Branch", address: "50/3 Shantinagar, dhaka", manager: 'mr.y' },
        { id: 3, branch_name: "Cantonment Branch", address: "house 43, road 9, dhaka cantonment , dhaka ", manager: 'mr.z' }
    ])
    const emplist = [
                ...
                <div className="page-header">
                    <div className="row align-items-center">
                        ...
                        <div className="col-auto float-right ml-auto">
                            <a href="#" className="btn add-btn" data-toggle="modal" data-target="#add_leavetype"><i className="fa fa-plus" /> Add Branch</a>
                        </div>
                    </div>
                </div>
                {/* /Page Header */}
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form>
                                ...
                                <div className="form-group">
                                    <label>Branch Manager <span className="text-danger">*</span></label>
                                    <Select
